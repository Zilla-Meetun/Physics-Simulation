...
namespace SOF
{
	...
	public:
		...
		void AssignTextureSampler(const std::string &uniform, Texture *t);
		void AssignTextureSampler(const std::string &uniform, Texture *t, int num );
		void AssignCubemapSampler(const std::string &uniform, Cubemap* t);
	};
}