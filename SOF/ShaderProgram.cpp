...
void SOF::ShaderProgram::AssignTextureSampler(const std::string &uniform, SOF::Texture *t)
{
	AssignTextureSampler(uniform, t, 0);
}

void SOF::ShaderProgram::AssignCubemapSampler(const std::string &uniform, SOF::Cubemap* t)
{
	AssignSampler(uniform, GL_TEXTURE_CUBE_MAP, t->GetObject());
}

void SOF::ShaderProgram::AssignTextureSampler(const std::string &uniform, SOF::Texture *t, int num )
{
